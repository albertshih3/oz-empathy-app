...
const Australia = () => {
        ...
        const fetchAnimals = async () => {
            ...
            try {
                ...
                if (!snapshot.empty) {
                    ...
                    // Filter animals in Australia location - handle both array and string formats
                    const australiaAnimals = allAnimals.filter(animal => {
                        ...
                        return animal.location === 'Australia' || animal.location === 'australia';
                    });

                    // Sort by name
                    const sortedAnimals = australiaAnimals.sort((a, b) =>
    ...
    const renderAnimalCard = ({ item }: { item: Animal }) => (
        ...
        >
            <Card.Section
                imageSource={item.photo ? { uri: item.photo } : require('../../assets/images/home/africa.png')}
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <ThemedView style={styles.emptyContainer}>
                        <ThemedText style={styles.emptyText}>No animals found in Australia.</ThemedText>
                    </ThemedView>
                }
            />
        </ThemedView>
