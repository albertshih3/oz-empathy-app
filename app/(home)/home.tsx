            ...
            <ScrollView>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly' }}>
                        <Card style={{ width: '45%' }} onPress={() => router.push('search')}>
                            ...
                            <Card.Section
                                content={[
                                    ...
                                    { text: 'Search for an animal by species!', text80: true, $textDefault: true }
                                ]}
                                style={{ padding: 15 }}
                            />
                        </Card>
                        ...
                        <Card style={{ width: '45%', marginTop: 15 }} onPress={() => router.push('africa')}>
                            <Card.Section imageSource={require('../../assets/images/home/africa.png')} imageStyle={{ height: 100, width: screenWidth > 768 ? screenWidth * 0.5 : 300, alignSelf: "center" }} />
                            <Card.Section
                                content={[
                                    { text: 'African Savanna', text60BO: true, $textDefault: true },
                                    { text: 'Explore and learn all about the African Savanna!', text80: true, $textDefault: true }
                                ]}
                                style={{ padding: 15 }}
                            />
                        </Card>
                        <Card style={{ width: '45%', marginTop: 15 }} onPress={() => router.push('cz')}>
                            <Card.Section imageSource={require('../../assets/images/home/children.png')} imageStyle={{ height: 100, width: screenWidth > 768 ? screenWidth * 0.5 : 300, alignSelf: "center" }} />
                            <Card.Section
                                content={[
